#not written my me, this script adds a column "n_segments" to the metadata file
# "n_segments" = number of segments the sample/strain has 
# (goal is to identify samples/strains with all 8 segments)
